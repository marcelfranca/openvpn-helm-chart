# ⚠️ This is from a deprecated chart

As of Nov 13, 2020, the original chart was not updated.
...
The entire list of helper scripts can be found on [templates/config-openvpn.yaml](openvpn/templates/config-openvpn.yaml)
